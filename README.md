...
- **Model** — отвечает за хранение и обработку данных, работу с API, бизнес-логику.
...
- хранение данных (список товаров, содержимое корзины, заказы),
- работу с API (получение списка товаров, отправка заказа),
- логику добавления, удаления, подсчёта итогов и валидации.

Основные классы:

- ProductModel: хранит и предоставляет список товаров.
- CartModel: управляет корзиной.
- OrderModel: содержит информацию о заказе.
...
- OrderView: модальное окно оформления заказа.
